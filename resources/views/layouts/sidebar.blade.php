<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main" data-color="success">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" id="dashboard-active-tag" href="{{ route('portal.index') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" id="users-active-tag" href="{{ route('portal.admin.users.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-users text-dark" id="users-icon"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" id="forests-active-tag" href="{{ route('portal.admin.forests.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-tree text-dark" id="forests-icon"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" id="trees-active-tag" href="{{ route('portal.admin.tree.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-seedling text-dark" id="trees-icon"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" id="plantspecies-active-tag" href="{{ route('portal.admin.forests.trees-species.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-dna text-dark" id="plant-species-icon"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" id="payments-active-tag" href="{{ route('portal.admin.payments.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-file-invoice-dollar text-dark" id="payments-icon"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" id="faq-active-tag" href="{{ route('portal.admin.faq.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-question text-dark" id="faqs-icon"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" id="contactreq-active-tag" href="{{ route('portal.admin.contact-requests.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-id-card text-dark" id="contacts-icon"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" id="announcements-active-tag" href="{{ route('portal.admin.announcements.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-users text-dark" id="announcements-icon"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link" id="events-active-tag" href="{{ route('portal.events.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-calendar-grid-58 text-dark" id="events-icon"></i>
                    </div>
