            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
                <ul class="navbar-nav navbar-nav-hover w-100">
                    ...
                    <li class="nav-item mx-2">
                        <a href="{{ route('home.contact.index') }}" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" id="dropdownMenuPages" data-bs-toggle="dropdown" aria-expanded="false">
                          Contact
                        </a>
                    </li>
