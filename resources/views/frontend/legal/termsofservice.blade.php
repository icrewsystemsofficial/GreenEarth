...
@section('content')
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center mx-auto my-auto">
                        <h1 class="mb-3 text-white opacity-8 display-2">Terms Of Service</h1>
                        <p class="mb-3 text-white opacity-6">Last updated September 30, 2021</p>
                    </div>
                </div>
            </div>
    ...
    <div class="container mx-auto my-auto">
        <h1 class="my-2 h5 mt-5">AGREEMENT TO TERMS</h1>
         <p> These Terms of Use constitute a legally binding agreement made between you,
        whether personally or on behalf of an entity (“you”) and icrewsystems ("Company,"
        “we," “us," or “our”), concerning your access to and use of the
        <a href="{{ route ('home.terms-of-service') }}">http://127.0.0.1:8000/home/legal/terms-of-service</a> website as well as any other media
        ...
        DISCONTINUE USE IMMEDIATELY. <br><br>
        ...
        <br>
        <h1 class="my-2 h5">INTELLECTUAL PROPERTY RIGHTS</h1>
        ...
        and the Marks. </p>
        <br>
        <h1 class="my-2 h5">USER REPRESENTATIONS</h1>
        <p>By using the Site, you represent and warrant that: (1) all registration information you
            ...
            (7) your use of the Site will not violate any applicable law or regulation.</p> <br>
        <p>If you provide any information that is untrue, inaccurate, not current, or incomplete,
            we have the right to suspend or terminate your account and refuse any and all
            current or future use of the Site (or any portion thereof).</p>
        <br>
        <h1 class="my-2 h5">USER REGISTRATION</h1>
        ...
        <br>
        <h1 class="my-2 h5">PROHIBITED ACTIVITIES</h1>
        <p>You may not access or use the Site for any purpose other than that for which we
        ...
        <p>1. Systematically retrieve data or other content from the Site to create or compile,
            ...
            or enforce limitations on the use of the Site and/or the Content contained therein. <br>
            ...
            with the use, features, functions, operation, or maintenance of the Site. <br>
            ...
            accesses the Site, or using or launching any unauthorized script or other software. <br>
            ...
            enterprise. <br>
            23. Use the Site to advertise or offer to sell goods and services. <br>
            24. Sell or otherwise transfer your profile. <br>
        </p>
        <br>
        <h1 class="my-2 h5">USER GENERATED CONTRIBUTIONS</h1>
        ...
        <p>1. The creation, distribution, transmission, public display, or performance, and the
            ...
            the Site and these Terms of Use. <br>
            ...
            libelous, slanderous, or otherwise objectionable (as determined by us). <br>
            ...
            pornography, or otherwise intended to protect the health or well-being of minors. <br>
            12. Your Contributions do not include any offensive comments that are connected
            to race, national origin, gender, sexual preference, or physical handicap. <br>
        ...
        <br>
        <h1 class="my-2 h5">CONTRIBUTION LICENSE</h1>
        <p>You and the Site agree that we may access, store, process, and use any information
            and personal data that you provide following the terms of the Privacy Policy and your
            choices (including settings).</p>
        <br>
        <p>By submitting suggestions or other feedback regarding the Site, you agree that we
        ...
        <br>
        <h1 class="my-2 h5">SUBMISSIONS</h1>
        ...
        <br>
        <h1 class="my-2 h5">SITE MANAGEMENT</h1>
        <p>We reserve the right, but not the obligation, to: (1) monitor the Site for violations of
            ...
            the Site.</p>
        <br>
        <h1 class="my-2 h5">PRIVACY POLICY</h1>
        <p>We care about data privacy and security. Please review our Privacy
            Policy: <a href="{{ route ('home.privacy-policy') }}">http://127.0.0.1:8000/home/legal/privacy-policy</a>. By using the Site, you
            agree to be bound by our Privacy Policy, which is incorporated into these Terms of
            Use. Please be advised the Site is hosted in the United Kingdom. If you access the
            ...
            United Kingdom, then through your continued use of the Site, you are transferring
            your data to the United Kingdom, and you agree to have your data transferred to and
            processed in the United Kingdom.
        </p>
        <br>
        <h1 class="my-2 h5">TERM AND TERMINATION</h1>
        ...
        <br>
        <h1 class="my-2 h5">MODIFICATIONS AND INTERRUPTIONS</h1>
        ...
        <br>
        <h1 class="my-2 h5">GOVERNING LAW</h1>
        <p>These Terms shall be governed by and defined following the laws of India.
            icrewsystems and yourself irrevocably consent that the courts of India shall have
            exclusive jurisdiction to resolve any dispute which may arise in connection with these
            terms.
        </p>
        <br>
        <h1 class="my-2 h5">DISPUTE RESOLUTION</h1>
        <br>
        <h1 class="my-2 h5">Binding Arbitration</h1>
        <p>Any dispute arising out of or in connection with this contract, including any question
            ...
            ICAC, which, as a result of referring to it, is considered as the part of this clause.</p>
        <br>
        <h1 class="my-2 h5">Restrictions</h1>
        <p>The Parties agree that any arbitration shall be limited to the Dispute between the
        ...
        <br>
        <h1 class="my-2 h5">Exceptions to Arbitration</h1>
        ...
        <br>
        <h1 class="my-2 h5">CORRECTIONS</h1>
        <p>There may be information on the Site that contains typographical errors,
            ...
            prior notice.</p>
        <br>
        <h1 class="my-2 h5">DISCLAIMER</h1>
        <p>THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE
            ...
            APPROPRIATE.</p>
        <br>
        <h1 class="my-2 h5">LIMITATIONS OF LIABILITY</h1>
        ...
        <br>
        <h1 class="my-2 h5">INDEMNIFICATION</h1>
        ...
        <br>
        <h1 class="my-2 h5">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND
            SIGNATURES
        </h1>
        ...
        <br>
        <h1 class="my-2 h5">CALIFORNIA USERS AND RESIDENTS</h1>
        <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint
            Assistance Unit of the Division of Consumer Services of the California Department of
            Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento,
            California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>
        <br>
        <h1 class="my-2 h5">MISCELLANEOUS
        </h1>
        ...
        <br>
        <h1 class="my-2 h5">CONTACT US</h1>
        <p>In order to resolve a complaint regarding the Site or to receive further information
            regarding use of the Site, please contact us at:
        </p>
        <p><b>icrewsystems</b><br>
            <b>Chennai, Tamil Nadu</b><br>
            <b>India</b><br>
            <b>Phone: +91 9884801349</b><br>
            <b>hello@icrewsystems.com</b></p>
    </div>
@endsection
