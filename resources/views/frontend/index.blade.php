...
<section class="header-2">
    ...
    <div class="container">
      ...
      <div class="row mt-4">
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-9" src="{{ asset('softui-design-system/assets/img/logos/gray-logos/logo-coinbase.svg') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-9" src="{{ asset('softui-design-system/assets/img/logos/gray-logos/logo-nasa.svg') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-9" src="{{ asset('softui-design-system/assets/img/logos/gray-logos/logo-netflix.svg') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-9" src="{{ asset('softui-design-system/assets/img/logos/gray-logos/logo-pinterest.svg') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-9" src="{{ asset('softui-design-system/assets/img/logos/gray-logos/logo-spotify.svg') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-9" src="{{ asset('softui-design-system/assets/img/logos/gray-logos/logo-vodafone.svg') }}" alt="logo">
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="py-7 bg-gradient-dark position-relative overflow-hidden">
    ...
    <img src="{{ asset('softui-design-system/assets/img/shapes/waves-white.svg') }}" class="position-absolute opacity-6 h-100 top-0 d-md-block d-none" alt="avatar">
